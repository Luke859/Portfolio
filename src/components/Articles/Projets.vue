    ...
    <section class="s8">
        <div class="main-container">
            <div class="text">
                ...
                <h2>Introduction</h2>
                <br>
                <p>Lors de mon stage, j'ai pu travailler sur différents projets. Pour ma première tâche j'ai principalement travaillé avec C# et microsoft Dynamics.</p> 
                <p>Ensuite, je suis parti sur un projet dont l'entreprise travaillait dessus depuis plusieurs années, où ils utilisaient principalement PHP et Symfony (Back-End).</p>
                <p>Je vous explique plus en détail mes différentes tâches que j'ai accomplie pendant mon stage.</p>
                <p>Dès mon premier jour à l'entreprise j'ai reçu ma première tâche.</p>
                <br>
                ...
                <p>Pour finaliser cette première tâche, la dernière chose à faire était de trier les informations voulurent pour chaque entreprise.</p>
                <br>
                ...
                <br>
                <p> Cette tâche permet donc à l'utilisateur s'il a vu ou non l'alerte qui lui à été envoyée.</p>
                ...
                <br>
                <br>
                <p>Tâche n°2 - Réception d'un email de changement de mot de passe quand le mot de passe de l'utilisateur est modifié.  </p>
                <br>
                <img id="photoTache1" src="../../assets/Tache2.png" />
                <br>
                <p> Cette tâche permet une meilleure sécurité et alerte l'utilisateur au cas où ce n'est pas lui.</p>
                <br>
                ...
                <p>Pour compléter cette tâche nous avons ajouter des messages de réussite et d'erreur pour l'ajout, la modification et la suppression.</p>
                <br>
